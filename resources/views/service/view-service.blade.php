						...
						<div class="card-header">
							...
							<div class="box-uploader">
                             <form action="{{ route('service-import') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <button class="btn btn-info btn-md">Import service</button>
                            </form>
							</div>
							</div>
							<div class="col-md-6">
                            <button type="submit" class="btn btn-dark btn-right"
                                onclick="window.location='{{ url('create-service') }}'">Add Service
                            </button>
                        </div>
						</div>
						</div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('/service/' . $item->id) }}"
                                                        title="View service"><button class="btn btn-success btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                                                    <a href="{{ url('/service/' . $item->id . '/edit') }}"
                                                        title="Edit service">
                                                        <button class="btn btn-primary btn-sm"><i class="fa fa-pencil-alt" aria-hidden="true"></i>
                                                        </button>
                                                    </a>

                                                    <form method="POST" action="{{ url('/service' . '/' . $item->id) }}"
