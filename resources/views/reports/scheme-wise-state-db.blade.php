...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Scheme wise SDB(State Development Budget)</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Master</a></li>
                        <li class="breadcrumb-item active">Scheme wise SDB(State Development Budget)</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                                    ...
                                    <thead>
                                        <tr>
                                            <th colspan="6" style="text-align: center">
                                                Department/Scheme wise Budget & Expenditure under Scheduled Castes Development Programme of the year 2022-23 (Rs. In Lakhs)
                                            </th>
                                        </tr>
                                        <tr>
                                            <th>MAJ/SM/MIN/SMIN/BUD</th>
                                            <th>Sector/ Department/ Scheme/SOE</th>
                                            <th>Outlay for 2022-23 (Rs. in Lakh)</th>
                                    ...
                                    <tbody id="tbody">
                                        ...
                                        @foreach(App\Models\Service::all() as $key => $value)
                                            ...
                                            @foreach(App\Models\Sector::where('service_id', $value->id)->get() as $sector_key => $sector_value)
                                                ...
                                                @foreach(App\Models\Department::where('id', $sector_value->department_id)->get() as $department_key => $department_value)
                                                        ...
                                                        @foreach(App\Models\Scheme_master::where('majorhead_id',$headvalue->id)->get() as $schemekey => $schemevalue)
                                                            ...
                                                            @foreach(App\Models\Soe_master::where('scheme_id',$schemevalue->id)->get() as $soekey => $soevalue)
                                                                <tr>
                                                                    ...
                                                                    <td> @if(array_sum($soe_outlay) > 0) {{ number_format(array_sum($exp_arr) / array_sum($soe_outlay) * 100 , 2, '.', '') }} @endif </td>
                                                                </tr>
                                                            @endforeach
                                                            @php
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th> @if(array_sum($outley_soe) > 0) {{ number_format(array_sum($exp_revised_outley_soe) / array_sum($outley_soe) * 100 , 2, '.', '') }} @endif </th>
                                                            </tr>
                                                        @endforeach
                                                    @endforeach
                                                    @php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th> @if(array_sum($dep_outley) > 0) {{ number_format(array_sum($exp_revised_outley) / array_sum($dep_outley) * 100 , 2, '.', '') }} @endif </th>
                                                    </tr>
                                                @endforeach
                                                @php
                                                ...
                                                <tr>
                                                    ...
                                                    <th> @if(array_sum($sector_outley) > 0) {{ number_format(array_sum($sector_exp_revised_outley) / array_sum($sector_outley) * 100 , 2, '.', '') }} @endif </th>
                                                </tr>
                                            @endforeach
                                            @php
                                            ...
                                            <tr>
                                                ...
                                                <th> @if(array_sum($service_outley) > 0) {{ number_format(array_sum($service_exp_revised_outley) / array_sum($service_outley) * 100 , 2, '.', '') }} @endif </th>
                                            </tr>
                                        @endforeach
                                        <tr>
                                            <td></td>
                                            ...
                                            <th> @if(array_sum($grand_outley) > 0) {{ number_format(array_sum($grand_exp_revised_outley) / array_sum($grand_outley) * 100 , 2, '.', '') }} @endif </th>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
