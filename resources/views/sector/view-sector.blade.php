            ...
            <div class="col-12 float-sm-right">
                <div class="card">
					<div class="card-header">
                            ...
                            <form action="{{ route('sector-import') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="file" name="file" id="customFile">
                            <button class="btn btn-info btn-md">Import sector</button>
                        </form>
							</div>
							</div>
							<div class="col-md-6">
                            <button type="submit" class="btn btn-dark btn-right"
                            onclick="window.location='{{ url('create-sector') }}'">Add Sector
                        </button>
                        </div>
						</div>
						</div>
                                ...
                                @if(isset($sector))
                                    @foreach($sector as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('/sector/' . $item->id) }}"
                                                    title="View sector"><button class="btn btn-success btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                                                <a href="{{ url('edit-sector?' . $item->id ) }}"
                                                    title="Edit sector">
