                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <button  class="btn btn-success" id="btnExport"><i class="fas fa-file-download"></i>&nbsp; Export Capital Scheme</button>
                                    {{-- <a class="btn btn-warning"
                                    href="{{ route('export-revenue-scheme') }}">
                                        Export Capital Scheme
                                    </a> --}}
                                </div>
                            </div>
                        </div>
                                    ...
                                    @if (isset($capitalData))
                                        @foreach ($capitalData as $item)
                                            <tr>
												...
												<a title="Add Revenue" href="{{ route('addCapitalRecord',$item->id)}}" class="btn btn-primary btn-sm"><i class="fa-plus fas"></i></a>
													<a title="View Revenue List" href="{{ route('viewCapitalRecord',$item->id)}}" class="btn btn-success btn-sm"><i class="fa-eye fas"></i></a>
												</td>
                                            </tr>
                                        @endforeach
                                    @else
...
@section('scripts')
    <script type="text/javascript">
        ...
        $('#btnExport').click(function() {
            $("#capitalTable").table2excel({
                filename: "Capital-scheme.xls"
            });
        });
